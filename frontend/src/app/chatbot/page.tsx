  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 dark:bg-slate-950 px-6 font-body">
      <div className="bg-white/90 dark:bg-slate-900/90 p-10 rounded-3xl shadow-xl dark:shadow-2xl border border-slate-200 dark:border-white/10 max-w-lg w-full text-center backdrop-blur-xl">
        ...
        <h1 className="font-headline text-3xl font-bold tracking-tight mb-2 text-slate-800 dark:text-gray-100">Global Chatbot Log</h1>
        <p className="text-slate-500 dark:text-slate-400 mb-8 font-medium">This section is currently under development. The floating chatbot widget is available on the dashboard.</p>
